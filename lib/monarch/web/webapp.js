...
function addPhenogridFiles(info) {
    ...
    info.pup_tent_js_libraries.push("/phenogrid-bundle.js");
    info.pup_tent_css_libraries.push("/phenogrid-bundle.css");
}
...
var fetchModelPage = function(request, id, fmt) {
    try {
        ...
        addGolrTable(info, "object_closure", id, 'disease-table', disease_filter, 'disease_model', '#diseases');
        ...
        addGolrTable(info, "object_closure", id, 'gene-table', gene_filter, 'gene_model', '#genes');
        ...
        addGolrTable(info, "object_closure", id, 'variant-table', variant_filter, 'variant_model','#variants');
...
app.get('/phenotype/:id.:fmt?',
        function(request, id, fmt){
            ...
            addGolrTable(info, "subject_closure", id, 'genotype-table', genotype_filter, 'phenotype_genotype',"#genotypes");
            ...
            addGolrTable(info, "subject_closure", id, 'model-table', model_filter, 'phenotype_model',"#models");
...
var fetchFeaturePage = function(request, id, fmt) {
    try {
        ...
        var genotype_filter = { field: 'object_category', value: 'genotype' };
        addGolrTable(info, "subject_closure", id, 'genotype-table', genotype_filter, 'gene_genotype','#genotypes');
        info.genotypeNum = engine.fetchAssociationCount(id, 'subject_closure', genotype_filter);
        
        var model_filter = { field: 'object_category', value: 'model' };
        addGolrTable(info, "subject_closure", id, 'model-table', model_filter, 'gene_model','#models');
        info.modelNum = engine.fetchAssociationCount(id, 'subject_closure', model_filter);
...
var fetchVariantPage = function(request, id, fmt) {
    try {
        ...
        var model_filter = { field: 'object_category', value: 'model' };
        addGolrTable(info, "subject_closure", id, 'model-table', model_filter, 'variant_model','#models');
        info.modelNum = engine.fetchAssociationCount(id, 'subject_closure', model_filter);
